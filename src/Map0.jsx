...
import { Box, Slider, Typography, Stack, ToggleButton, ToggleButtonGroup } from "@mui/material";
...
const MapComponent = () => {
  ...
  const fetchFilteredData = () => {
    ...
    axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/vibrations?${params.toString()}`)
      .then((response) => {
